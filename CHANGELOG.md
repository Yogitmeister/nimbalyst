...
- Sub-agent transcript cards show the provider, actual model, reasoning effort, extended-reasoning state and every safe model launch parameter on desktop and iOS.
