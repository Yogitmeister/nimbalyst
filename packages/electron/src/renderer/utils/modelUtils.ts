...
export { type EffortLevel, EFFORT_LEVELS, DEFAULT_EFFORT_LEVEL, parseEffortLevel, supportedEffortLevelsForModel, clampEffortForModel } from '@nimbalyst/runtime/ai/server/effortLevels';
 ...
 * Supported: Claude Code Fable, Opus, and Sonnet variants including pinned
 * versions and 1M rows, plus OpenAI Codex models.
 */
