...
export class OpenAICodexProvider extends BaseAgentProvider {
  ...
  private static readonly MODEL_REPLACEMENTS = new Map<string, string>([
    ...
    ['gpt-5.6', 'gpt-5.6-sol'],
    // 'gpt-5.2' was dropped from the Codex catalog in the 2026-07-10 GA-day
    // refresh (see FALLBACK_MODELS comment above) -- repoint the bare 'gpt-5'
    // alias to the current default tier instead of a dead target.
    ['gpt-5', 'gpt-5.6-terra'],
    ['gpt-5-codex', 'gpt-5.4'],
